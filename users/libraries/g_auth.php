 ...
 * g_auth Library
 *
 * Provides additional authentication functions for managing the google authentication
 * 
 * This has been take from: https://www.idontplaydarts.com/wp-content/uploads/2011/07/ga.php_.txt
 * and modified for the use of CIBonfire.
 *
 *
 * @package    Bonfire
...
class G_auth
{
    ...
    public function __construct()
    {
        ...
        log_message('debug', 'g_auth class initialized.');
    }
...
//end __construct()
     ...
     * @return string
     */
    public function get_qr_url_code($user_name, $site_name, $salt)
    {
        $urlencoded = urlencode('otpauth://totp/' . $user_name . '-' . $site_name . '?secret=' . $salt . '');
