...
<?php $this->load->view('users/user_meta', array('frontend_only' => true)); ?>
            ...
            <div class="form-actions">
                ...
                <?php if ($google_auth_status == 0): ?>
                    <input type="submit" name="google_authentication_add" class="btn btn-warning" value="<?php echo lang('us_action_add') . ' ' . lang('us_google_authentication'); ?>" />
                <?php else: ?>
                    <input type="submit" name="google_authentication_remove" class="btn btn-danger" value="<?php echo lang('us_action_remove') . ' ' . lang('us_google_authentication'); ?>" />
                <?php endif; ?>
